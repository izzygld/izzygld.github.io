    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            infowindow.setContent(
                "<div class='infowindows'><b>Attraction: </b><br>" +
                marker.name +
                "<br><br>" +
                marker.description +
                "<br><br><b>Wikipedias Article:</b><br>" +
                marker.wikipedia +
...
function initMap() {
    ...
    for (var i = 0; i < listLocationsLength; i++) {
        ...
        var image = new google.maps.MarkerImage(imageBase + listLocations[i].icon, null, null,
        ...
        google.maps.event.addListener(marker, 'click', (function(marker, i) {
            ...
            return function() {
               ...
               // document.getElementByClassName("location").style.display = 'none';
...
var alertMaps = "So Sorry! The map didn't load.";
